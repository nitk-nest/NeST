...
If the path specified by 'VIDEO_PATH' is invalid, then the API will automatically resort to downloading a sample 1-minute video from the Internet as a fallback mechanism. The sample video will be downloaded from https://download.blender.org/durian/trailer/sintel_trailer-1080p.mp4 .
