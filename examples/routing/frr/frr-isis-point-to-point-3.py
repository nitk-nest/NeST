...
config.set_value("routing_suite", "frr")  # `quagga` is default in NeST.
...
# Use ISIS to form routes
RoutingHelper(protocol="isis").populate_routing_tables()
