...
# to `point-to-point-3.py` available in `examples/basic-examples`, the only
...
# `r1`. We assume that the IPv6 address of this network is `2001::1/122`
...
etr2a.set_address("2001::2:2/122")

# Assign IPv6 addresses to interfaces in the network which is on the right of
# `r2`. We assume that the IPv6 address of this network is `2001::3/122`
etr2b.set_address("2001::3:1/122")
eth2.set_address("2001::3:2/122")
