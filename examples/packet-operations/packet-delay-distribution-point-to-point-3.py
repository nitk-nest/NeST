...
# Set a delay of 100ms, jitter 10ms and distribution to normal
# on the link from `h1` to `r1`.
eth1.set_delay_distribution("100ms", "10ms", "normal")
...
# `Ping` from `h1` to `h2`.
# Note: Delays will be distributed normally with a variation (jitter) of 10ms
