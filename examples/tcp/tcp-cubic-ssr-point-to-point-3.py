...
exp = Experiment("tcp-cubic-ssr-point-to-point-3")
...
# Configure the TCP parameter to disable SSR by setting the parameter value to 0
# Note: SSR algorithm works only at the sender. Hence, we disable it only in h1.
h1.configure_tcp_param("slow_start_after_idle", "0")
...
h1.configure_tcp_param("slow_start_after_idle", "1")
