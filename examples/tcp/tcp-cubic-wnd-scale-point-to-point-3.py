...
exp = Experiment("tcp-cubic-wnd-scale-point-to-point-3")
...
# Configure the tcp parameter to disable Window Scaling by setting the
# parameter value to 0.
# Note: Window Scaling is set for both sender and reciever during packet
# transfer.
h1.configure_tcp_param("window_scaling", "0")
h2.configure_tcp_param("window_scaling", "0")
...
h1.configure_tcp_param("window_scaling", "1")
h2.configure_tcp_param("window_scaling", "1")
