...
@unittest.skipUnless(path.isdir('/proc/sys/net/mpls') or system('modprobe mpls_iptunnel') == 0,\
    "Couldn't load mpls")
class TestStaticMPLS(unittest.TestCase):
    ...
    def test_routing(self):
        (eth_n0_r0, eth_r0_n0) = connect(
            self.n0, self.r0, 'eth-n0_r0', 'eth-r0_n0')
        (eth_r0_r1, eth_r1_r0) = connect(
            self.r0, self.r1, 'eth-r0r1-0', 'eth-r1r0-0')
        (eth_r1_n1, eth_n1_r1) = connect(
            self.r1, self.n1, 'eth-r1n1-0', 'eth-n1r1-0')
        ...
        self.n0.add_route_mpls_push(
            '10.0.3.0/24', eth_r0_n0.get_address(), 101)
        self.r0.add_route_mpls_switch(101, eth_r1_r0.get_address(), 102)
        self.r1.add_route_mpls_pop(102, eth_n1_r1.get_address())

        self.n1.add_route_mpls_push(
            '10.0.1.0/24', eth_r1_n1.get_address(), 201)
