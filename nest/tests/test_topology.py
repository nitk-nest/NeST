...
class TestTopology(unittest.TestCase):
    ...
    def test_invalid_interface_name(self):
        ...
        err = cm.exception
        self.assertEqual(str(err), 'Interface name looonginvalidname is too long. Interface names '
    ...
    def test_invalid_veth_name(self):
        ...
        with self.assertRaises(ValueError) as cm:
            connect(node0, node1)
        err = cm.exception
        self.assertEqual(str(err), 'Auto-generated veth interface name longname0-longname1-0 is '
    ...
    def test_valid_veth_name(self):
        ...
        self.assertEqual(eth0.name, 'node0-node1-0', 'eth0 has unexpected autogenerated name')
        self.assertEqual(eth1.name, 'node1-node0-0', 'eth1 has unexpected autogenerated name')

        eth2, eth3 = connect(node0, node1)

        self.assertEqual(eth2.name, 'node0-node1-1', 'eth2 has unexpected autogenerated name')
        self.assertEqual(eth3.name, 'node1-node0-1', 'eth3 has unexpected autogenerated name')
    ...
    def test_invalid_ifb_interface_name(self):
        ...
        err = cm.exception
        self.assertEqual(str(err), 'Auto-generated IFB interface name ifb-node0-node1-0 is too '
