...
This folder also consists of a log file named 'mpeg_dash_gpac_{server_ns}_to_{client_ns}.log' that contains
the raw logs generated by GPAC. This has been provided incase the user wishes to manually parse the logs.
